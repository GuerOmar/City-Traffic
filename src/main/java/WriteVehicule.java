...
public class WriteVehicule extends TableReducer<Text, Text, Text> {
    ...
    public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        for (Text val : values) {
            ...
            if(key.toString().equals("#Vehicule")){
                ...
                put.addColumn(Bytes.toBytes("day_stats"), Bytes.toBytes("vehicule"), key.toString().getBytes());
                for(int i=0; i<line.length ; i++){
